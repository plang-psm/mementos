  ...
  return (
    <>
      <motion.div
        ...
        ref={featRef}
      >
        <div className='unlimited-photos py-12 md:py-24 lg:mx-auto lg:flex lg:justify-between lg:items-center lg:gap-4 box-border overflow-x-hidden'>
          <div className='image order-2 lg:w-[500px] xl:w-full pb-8 lg:pb-0'>
            <Image
              src={PhotoBooth}
              className='mx-auto lg:ml-auto lg:mr-0 w-full h-[450px] object-cover object-top md:object-center lg:min-w-[330px] lg:max-w-[500px] rounded-3xl'
              width={0}
              height={0}
              sizes='100vw'
              placeholder='blur'
          ...
          <div className='content mx-auto max-w-[500px] md:max-w-full lg:min-w-[300px] lg:max-w-[500px] xl:max-w-[800px]'>
            <h3 className='text-3xl md:text-5xl lg:text-6xl font-extrabold uppercase'>
              Unlimited Digital Photos
            </h3>
            <p className='py-4 md:text-lg tracking-wide w-full'>
        ...
        <div className='photo-templates py-12 md:py-24 lg:mx-auto lg:flex lg:justify-between lg:items-center lg:gap-4'>
          <div className='image lg:w-[500px] xl:w-full pb-8 lg:pb-0'>
            <Image
              src={CustomTemplate}
              className='mx-auto lg:mr-auto lg:ml-0 w-full h-[450px] object-cover object-center lg:min-w-[330px] lg:max-w-[500px] rounded-3xl'
              width={0}
              height={0}
              sizes='100vw'
          ...
          <div className='content mx-auto max-w-[500px] md:max-w-full text-end lg:min-w-[300px] lg:max-w-[500px] xl:max-w-[800px]'>
            <h3 className='text-3xl md:text-5xl lg:text-6xl font-extrabold uppercase text-end'>
        ...
        <div className='instant-photos py-12 lg:py-24 lg:mx-auto lg:flex lg:justify-between lg:items-center lg:gap-4'>
          <div className='image order-2 lg:w-[500px] xl:w-full pb-8 lg:pb-0'>
            <Image
              src={VdayGif}
              className='mx-auto lg:ml-auto lg:mr-0 w-full h-[450px] object-cover md:object-center lg:min-w-[330px] lg:max-w-[500px] rounded-3xl'
              width={0}
              height={0}
              sizes='100vw'
          ...
          <div className='content mx-auto max-w-[500px] md:max-w-full lg:md:min-w-[300px] lg:max-w-[500px] xl:max-w-[800px]'>
            <h3 className='text-3xl md:text-5xl lg:text-6xl font-extrabold uppercase'>
